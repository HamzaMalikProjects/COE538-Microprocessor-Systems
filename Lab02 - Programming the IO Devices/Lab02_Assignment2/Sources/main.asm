...
;*******************************************************************
;* Writing to the LCD *   Created by: Hamza Malik 501112545        *
;*******************************************************************
; export symbols
...
HEX1              FCB       $91                 ; ASCII Character
HEX2              FCB       $00                 ; ASCII Character
...
MainLoop          JSR       clrLCD            ; clear LCD & home cursor
                  ...
                  JSR       del_50us
                  BRA       MainLoop          ; Loop
msg1              dc.b       "Hamza Malik ",  0  ; message to be displayed
